...
//Shuffling the state-capital pairs
for (int i=0; i <stateCapital.length; i++) {
    int randomIndex = (int)(Math.random() * stateCapital.length);

    String[] temp = stateCapital[i];
    stateCapital[i] = stateCapital[randomIndex];
    stateCapital[randomIndex] = temp;
}
